                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                            color: whiteColor,
                            border: Border(
                              right: BorderSide(width: 2, color: textColor),
                            ),
                          ),
                          child: Center(
                            child: Text(
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                              ...
                              border: Border(
                                right: BorderSide(width: 2, color: textColor),
                                top: BorderSide(width: 2, color: textColor),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                              color: whiteColor,
                              border: Border(
                                left: BorderSide(width: 2, color: textColor),
                                top: BorderSide(width: 2, color: textColor),
                                bottom: BorderSide(width: 2, color: textColor),
                              )),
                          child: Center(
